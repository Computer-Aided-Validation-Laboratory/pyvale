...
def main() -> None:
    ...
    # NOTE: pyvale will not call show allowing the user to construct several
    # figures before showing them or to not show them at all and save to disk.
    # The user must call plt.show()
    plt.show()
