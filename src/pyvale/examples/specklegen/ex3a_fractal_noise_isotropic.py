...
# The parameters are set to generate isotropic fractal noise in this example. The number of periods width- and height-wise are the same.
...
# This noise involves layering multiple frequencies of Perlin noise (which are referred to as octaves) to create a more complex pattern.
...
args.res_width = 25
args.res_height = 25
args.output_path = "src/pyvale/examples/specklegen/output/ex3a"
