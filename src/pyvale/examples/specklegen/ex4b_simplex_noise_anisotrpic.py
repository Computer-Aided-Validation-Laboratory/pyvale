"""
Specklegen: Speckle pattern generation using anisotropic Simplex noise
================================================================================
Script to generate a synthetic speckle pattern made using anisotropic Simplex noise, run diagnostics on the generated image, and save both the image
and diagnostics to the selected folder. Anisotroic Simplex noise in this case means that the speckle size is different in horisontal and vertical directions.
"""
...
# The parameters are set to generate anisotropic Simplex noise in this example. 
...
args.speckle_size_width = 10
args.speckle_size_height = 30
args.seed = 1234
args.output_path = "src/pyvale/examples/specklegen/output/ex4b"
