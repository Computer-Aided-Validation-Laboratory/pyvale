...
"""
Specklegen: Speckle pattern generation using anisotropic fractal noise
================================================================================
...
and diagnostics to the selected folder. Anisotroic fractal noise in this case means that the speckle size is different in horisontal and vertical directions.
"""
...
# The parameters are set to generate anisotropic fractal noise in this example. The number of periods width- and height-wise are different.
# The number of octaves is set to 3 to generate fractal noise. This is an additioal parameter compared to the Perlin noise examples.
...
args.octaves = 3
args.type_gen = "fractal"
args.res_width = 10
args.res_height = 25
args.output_path = "src/pyvale/examples/specklegen/output/ex3b"
