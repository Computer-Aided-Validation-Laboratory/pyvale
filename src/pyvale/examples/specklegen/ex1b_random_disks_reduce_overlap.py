...
subfolder = Path(
    ...
    f"{image_depth}_{theme.value}_{seed}_{sigma_blur}_{reduce_overlap}"
)
...
# %%
# .. image:: ../../../../_static/specklegen_ex1b_speckle_pattern.jpg
#    :alt: Speckle pattern.
#    :width: 800px
#    :align: center
...
# %%
# .. image:: ../../../../_static/specklegen_ex1b_frequency_spectrum.jpg
...
# %%
# .. image:: ../../../../_static/specklegen_ex1b_pixel_value_histogram.jpg
...
# %%
# .. image:: ../../../../_static/specklegen_ex1b_autocovariance.jpg
