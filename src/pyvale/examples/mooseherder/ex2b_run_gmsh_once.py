...
from pyvale.mooseherder import gmsh_availability

if not gmsh_availability().available:
    print("Gmsh is unavailable: skipping this example.")
    print("Install Gmsh and make sure the 'gmsh' executable is on PATH.")
else:
    main()
