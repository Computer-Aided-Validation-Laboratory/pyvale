...
for kk in disp_keys:
    ...
    if pv_plot.off_screen: 
        pv_plot.screenshot(output_path/f"adv_ex3c_locs_{kk}.png")
    else:
        pv_plot.show()

# %%
# .. image:: ../../../../_static/adv_ex3c_locs_disp_y.png
...
for kk in disp_keys:
    ...
    fig.savefig(output_path/f"adv_ex3c_traces_{kk}.png",
                dpi=300,
                bbox_inches="tight")
...
# %%
# .. image:: ../../../../_static/adv_ex3c_traces_disp_y.png
