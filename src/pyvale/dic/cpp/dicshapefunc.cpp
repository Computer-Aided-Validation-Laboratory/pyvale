...
namespace shapefunc {
    ...
    // Function pointer 
    void (*get_pixel)(double &, double &, double, double, std::vector<double> &);
    void (*get_dshape_dp)(std::vector<double>&, double, double, double, double);
    void (*get_displacement)(util::Results &results, double ss_x, double ss_y, std::vector<double> &p);
    ...
    inline void get_displacement_from_quad(util::Results &res, double ss_x, double ss_y, std::vector<double> &p){
    ...
    inline void get_displacement_from_affine(util::Results &res, double ss_x, double ss_y, std::vector<double> &p){
    ...
    inline void get_displacement_from_rigid(util::Results &res, double ss_x, double ss_y, std::vector<double> &p){
        res.u = p[0];
        res.v = p[1];
        res.mag = std::sqrt(res.u*res.u + res.v*res.v);
    }
