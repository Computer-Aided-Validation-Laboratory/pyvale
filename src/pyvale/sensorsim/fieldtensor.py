...
class FieldTensor(IField):
    ...
    """
    __slots__ = ("_norm_comp_keys","_dev_comp_keys","_spatial_dims","_sim_data",
    ...
    def __init__(self,
        ...
        norm_comp_keys : tuple[str,...]
            ...
            nodal variables dictionary. For example ('stain_xx','strain_yy',) 
            for strain in 2D and ('strain_xx','strain_yy','strain_zz') in 3D.
        norm_dev_keys : tuple[str,...]
            String keys for the tensor deviatoric field components in the 
            `SimData` nodal variables dictionary. For example ('stain_xy',) 
            for strain in 2D and ('strain_xy','strain_xz','strain_yz') in 3D.
        spatial_dims : EDim
    ...
    def get_all_components(self) -> tuple[str, ...]:
        """Gets the string keys for the components of the physical field. For
