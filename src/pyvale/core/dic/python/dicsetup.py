...
# --------------------------------------------------------------------------------------------------------------
# Below is for cuda setup. Leaving commented out for now while focusing on CPU.
# Will integrate at a later date
# --------------------------------------------------------------------------------------------------------------
...
#     Starts by looking for the CUDAHOME env variable. If not found, 1everything is based on finding 'nvcc' in the PATH.
#     """
