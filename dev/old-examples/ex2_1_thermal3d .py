...
def main() -> None:
    ...
    # This is the path where we will save figures generated by pyvale
    ...
    if pv_plot_mode == 'save_fig':
        ...
        pv_plot.camera_position = [(59.354, 43.428, 69.946),
                                   (-2.858, 13.189, 4.523),
                                   (-0.215, 0.948, -0.233)]
        save_render = save_path/"monoblock_thermal_sim_view.svg"
    ...
    if trace_plot_mode == 'save_fig':
        save_traces = save_path/'monoblock_thermal_traces.png'
