...
DATASET_ROOT = Path(
    "/home/robh/1_Projects/pyvale-vfm-test-data/notched-ebw/synthetic-fe/wdbn1-idealised-yield/pyvale-vfm"
)
EXPERIMENT_DATA_PATH = DATASET_ROOT / "prepared"
KNOWN_PARAMETER_MAPS = EXPERIMENT_DATA_PATH / "known_parameter_maps.npz"
RESULT_BUNDLE = (
    DATASET_ROOT
    / "identification"
    / "prepared"
