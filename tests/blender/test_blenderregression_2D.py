...
def cam_from_resolution():
    return np.array([[50, 66, 56, 49, 67, 82, 84, 77, 67, 83, 89, 90, 85, 83, 84, 57,
        62, 92, 86, 68],
...
def eevee_engine():
    return np.array([[85, 74, 53, 43, 53, 49, 43, 60, 57, 32, 39, 72, 63, 49, 38, 33,
       ...
       [75, 63, 77, 59, 34, 66, 60, 53, 61, 26, 43, 40, 53, 60, 55, 40,
        58, 53, 54, 52],
       [53, 66, 74, 29, 34, 56, 57, 23,  1,  0,  0,  1, 27, 51, 63, 49,
        78, 53, 54, 50],
       [42, 51, 63, 63, 37, 23,  1,  1,  0,  1,  0,  0,  0,  0, 11, 40,
        58, 61, 55, 40],
       ...
       [24, 44, 53, 64, 27,  0,  0,  1,  0,  0,  0,  1,  1,  0,  0, 11,
        40, 54, 42, 37],
       [37, 69, 74, 44, 47, 25,  0,  0,  1,  1,  1,  1,  1,  2, 20, 33,
        53, 39, 55, 67],
       [60, 47, 74, 72, 53, 72, 13, 21, 13,  1,  0,  1,  4, 34, 70, 52,
        49, 66, 50, 69],
       [33, 56, 72, 62, 55, 68, 37, 71, 71, 34, 11, 36, 57, 54, 63, 37,
        73, 62, 57, 80],
       [47, 55, 72, 26, 31, 30, 27, 40, 64, 64, 40, 64, 81, 77, 62, 33,
        55, 57, 32, 48],
